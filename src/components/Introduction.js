        ...
        <>
            ...
            <Jumbotron style={{backgroundColor: '#fff'}}>
                ...
                <ListGroup  style={{width: 'max-content', }}>
                    <ListGroup.Item>Kumail Rajani</ListGroup.Item>
                    <ListGroup.Item>Research Fellow</ListGroup.Item>
                    <ListGroup.Item>Institute of Arab and Islamic Studies</ListGroup.Item>
                    <ListGroup.Item>University of Exeter</ListGroup.Item>
                    <ListGroup.Item>Stocker Road, Exeter, EX4 4ND.</ListGroup.Item>
                    <ListGroup.Item>Law, Authority and Learning in Imami Shiʿite Islam: <a href="www.lawalisi.eu">www.lawalisi.eu</a></ListGroup.Item>
                </ListGroup>
            </Jumbotron>
        </>
    )
